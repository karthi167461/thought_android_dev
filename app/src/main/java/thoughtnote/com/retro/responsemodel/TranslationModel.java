package thoughtnote.com.retro.responsemodel;
...
public class TranslationModel {
    ...
    public String text_please_wait_for_an_otp;

    @SerializedName("text_enter_otp_below")
    public String text_enter_otp_below;

    @SerializedName("text_edit_number")
    public String text_edit_number;

    @SerializedName("text_resend")
    public String text_resend;

    @SerializedName("text_verify_otp")
    public String text_verify_otp;

    @SerializedName("text_firstname")
    public String text_firstname;

    @SerializedName("text_sign_up")
    public String text_sign_up;
    ...
    public String text_title_greetings;
    ...
    public String Validate_OTP_Empty;

    @SerializedName("Validate_OTP_length")
    public String Validate_OTP_length;
    ...
    @SerializedName("Takeaphoto")
    public String Takeaphoto;

    @SerializedName("ChooseFromGall")
    public String ChooseFromGall;

    @SerializedName("text_cancel")
    public String text_cancel;

    @SerializedName("Alert_Tit_Add_Photo")
    public String Alert_Tit_Add_Photo;

    @SerializedName("Validate_FirstName")
    public String Validate_FirstName;

    @SerializedName("Validate_LastName")
    public String Validate_LastName;

    @SerializedName("Validate_Email")
    public String Validate_Email;

    @SerializedName("Validate_InvalidEmail")
    public String Validate_InvalidEmail;

    @SerializedName("Validate_Password")
    public String Validate_Password;

    @SerializedName("Validate_NewPassword")
    public String Validate_NewPassword;

    @SerializedName("Validate_ConfirmPassword")
    public String Validate_ConfirmPassword;

    @SerializedName("Validate_PhoneNumber")
    public String Validate_PhoneNumber;

    @SerializedName("Validate_notmatch")
    public String Validate_notmatch;
    ...
    @SerializedName("Toast_UserLogged")
    public String Toast_UserLogged;

    @SerializedName("text_social_media")
    public String text_social_media;
    ...
    @SerializedName("Txt_title_Login")
    public String Txt_title_Login;
    ...
    @SerializedName("text_Enter_Address")
    public String text_Enter_Address;

    @SerializedName("Txt_title_SocialLogin")
    public String Txt_title_SocialLogin;
    ...
    @SerializedName("text_title_Money")
    public String text_title_Money;
    ...
    @SerializedName("Toast_card_delete")
    public String Toast_card_delete;

    @SerializedName("text_desc_delete")
    public String text_desc_delete;

    @SerializedName("Toast_AddCard")
    public String Toast_AddCard;

    @SerializedName("text_sharequote")
    public String text_sharequote;

    @SerializedName("text_note_referral")
    public String text_note_referral;

    @SerializedName("text_share_ref")
    public String text_share_ref;

    @SerializedName("txt_PickupFrom")
    public String txt_PickupFrom;


    @SerializedName("txt_cancelRide")
    public String txt_cancelRide;

    @SerializedName("txt_Dropat")
    public String txt_Dropat;

    @SerializedName("txt_DropAddress")
    public String txt_DropAddress;

    @SerializedName("txt_PickupAddress")
    public String txt_PickupAddress;

    @SerializedName("txt_gettingAddr")
    public String txt_gettingAddr;

    @SerializedName("txt_Ridelater")
    public String txt_Ridelater;

    @SerializedName("txt_RideNow")
    public String txt_RideNow;

    @SerializedName("txt_pickupTime")
    public String txt_pickupTime;

    @SerializedName("txt_ConfirmBooking")
    public String txt_ConfirmBooking;

    @SerializedName("txt_EnterDrop")
    public String txt_EnterDrop;

    @SerializedName("txt_EnterPick")
    public String txt_EnterPick;

    @SerializedName("txt_GetTotalFare")
    public String txt_GetTotalFare;

    @SerializedName("Txt_HowWouldyouPay")
    public String Txt_HowWouldyouPay;

    @SerializedName("Txt_otherpayment")
    public String Txt_otherpayment;
    ...
    @SerializedName("txt_booking_page")
    public String txt_booking_page;

    @SerializedName("txt_Work")
    public String txt_Work;

    @SerializedName("txt_Other")
    public String txt_Other;

    @SerializedName("hint_NameyourFav")
    public String hint_NameyourFav;

    @SerializedName("txt_save")
    public String txt_save;

    @SerializedName("Validate_NickName")
    public String Validate_NickName;

    @SerializedName("Toast_Favorite_Add")
    public String Toast_Favorite_Add;

    @SerializedName("hint_Search_locality")
    public String hint_Search_locality;

    @SerializedName("txt_Favourites")
    public String txt_Favourites;

    @SerializedName("txt_delete")
    public String txt_delete;

    @SerializedName("txt_FareDetails")
    public String txt_FareDetails;

    @SerializedName("Txt_i")
    public String Txt_i;

    @SerializedName("txt_Taxes")
    public String txt_Taxes;

    @SerializedName("txt_Totalfare")
    public String txt_Totalfare;

    @SerializedName("txt_EstimateNotes")
    public String txt_EstimateNotes;

    @SerializedName("txt_Gotit")
    public String txt_Gotit;

    @SerializedName("txt_Basefare")
    public String txt_Basefare;

    @SerializedName("txt_RateperKm")
    public String txt_RateperKm;

    @SerializedName("txt_Ridetime")
    public String txt_Ridetime;

    @SerializedName("txt_Taxesextra")
    public String txt_Taxesextra;

    @SerializedName("Alert_Select_carType")
    public String Alert_Select_carType;
    ...
    public String txt_skip;

    @SerializedName("txt_Apply")
    public String txt_Apply;

    @SerializedName("Validate_EnterDropLocation")
    public String Validate_EnterDropLocation;

    @SerializedName("Validate_SelectPayment")
    public String Validate_SelectPayment;
    ...
    public String Validate_EnterDescription;
    ...
    public String txt_logout_company;

    @SerializedName("txt_Distance")
    public String txt_Distance;

    @SerializedName("txt_Promo")
    public String txt_Promo;

    @SerializedName("txt_Choose")
    public String txt_Choose;

    @SerializedName("txt_waitingforDriver")
    public String txt_waitingforDriver;

    @SerializedName("Fav_already_saved")
    public String Fav_already_saved;
    ...
    @SerializedName("txt_arrived")
    public String txt_arrived;

    @SerializedName("Txt_TripStarted")
    public String Txt_TripStarted;

    @SerializedName("Txt_TripCompleted")
    public String Txt_TripCompleted;

    @SerializedName("Txt_DriverAccepted")
    public String Txt_DriverAccepted;

    @SerializedName("Txt_TripCanceled")
    public String Txt_TripCanceled;

    @SerializedName("txt_Enter_Promo")
    public String txt_Enter_Promo;

    @SerializedName("Txt_title_Promocode")
    public String Txt_title_Promocode;

    @SerializedName("Validate_Promocode")
    public String Validate_Promocode;

    @SerializedName("text_title_History")
    public String text_title_History;

    @SerializedName("Txt_Schedule_Alert")
    public String Txt_Schedule_Alert;

    @SerializedName("Txt_RideHas")
    public String Txt_RideHas;

    @SerializedName("Txt_RideCreated")
    public String Txt_RideCreated;

    @SerializedName("Txt_Schedule")
    public String Txt_Schedule;

    @SerializedName("Txt_RideScheduled")
    public String Txt_RideScheduled;

    @SerializedName("txt_card")
    public String txt_card;

    @SerializedName("Toast_Forgot_Password")
    public String Toast_Forgot_Password;

    @SerializedName("Txt_NoDriverFound")
    public String Txt_NoDriverFound;

    @SerializedName("txt_Servicenotavailable")
    public String txt_Servicenotavailable;

    @SerializedName("dialog_no_gps")
    public String dialog_no_gps;

    @SerializedName("dialog_no_gps_messgae")
    public String dialog_no_gps_messgae;

    @SerializedName("dialog_enable_gps")
    public String dialog_enable_gps;
...
/*
    ...
    @SerializedName("text_double_tap_exit")
    public String text_double_tap_exit;

    @SerializedName("Txt_NoServiceAvailable")
    public String Txt_NoServiceAvailable;

    @SerializedName("text_setvice_tax")
    public String text_setvice_tax;
    /*..................................*//*
    @SerializedName("text_accepted")
    public String text_accepted;*/

    @SerializedName("text_user_exists_alert")
    public String text_user_exists_alert;

    @SerializedName("text_in")
    public String text_in;
    @SerializedName("text_bill_details")
    public String text_bill_details;
    @SerializedName("text_enter_social")
    public String text_enter_social;
    ...
    public String text_pass_sent_email = "text_pass_sent_email";
    @SerializedName("hint_add_reason_for_cancel")
    public String hint_add_reason_for_cancel = "hint_add_reason_for_cancel";
    @SerializedName("text_faq")
    public String text_faq = "text_faq";
    @SerializedName("hint_first_name")
    public String hint_first_name = "hint_first_name";
    @SerializedName("hint_last_name")
    public String hint_last_name = "hint_last_name";
    ...
    public String text_location_enable_desc = "text_location_enable_desc";
    @SerializedName("text_turn_location_on")
    public String text_turn_location_on = "text_turn_location_on";
    ...
    public String text_submit = "text_submit";
    ...
    @SerializedName("driver_away_txt")
    public String driver_away_txt = "driver_away_txt";
    @SerializedName("txt_normal_ride")
    public String txt_normal_ride = "txt_normal_ride";
    @SerializedName("text_agree")
    public String text_agree = "text_agree";
    @SerializedName("txt_ride_with_key")
    public String txt_ride_with_key = "txt_ride_with_key";
    @SerializedName("txt_cancel_charge")
    public String txt_cancel_charge = "txt_cancel_charge";
    @SerializedName("txt_scan_qrcode")
    public String txt_scan_qrcode = "txt_scan_qrcode";
    @SerializedName("txt_enter_privatekey")
    public String txt_enter_privatekey = "txt_enter_privatekey";
    @SerializedName("do_you_want_top_driver")
    public String do_you_want_top_driver = "do_you_want_top_driver";
    @SerializedName("yes")
    public String yes = "yes";
    @SerializedName("no")
    public String no = "no";
    @SerializedName("applicable")
    public String applicable = "applicable";
    ...
    public String text_select_language = "text_select_language";
    ...
    public String add_charges = "add_charges";
    ...
    @SerializedName("txt_req_sent")
    public String txt_req_sent = "txt_req_sent";
    ...
    @SerializedName("txt_unbilled")
    public String txt_unbilled = "txt_unbilled";
    ...
    @SerializedName("text_change_drop")
    public String text_change_drop = "text_change_drop";
    @SerializedName("text_promo_applied")
    public String text_promo_applied = "text_promo_applied";
    @SerializedName("txt_promo_bonus")
    public String txt_promo_bonus = "txt_promo_bonus";
    ...
    @SerializedName("txt_captain_Accepted")
    public String txt_captain_Accepted = "txt_captain_Accepted";
    @SerializedName("text_otp")
    public String text_otp = "text_otp";
    @SerializedName("txt_trip_started")
    public String txt_trip_started = "txt_trip_started";
    @SerializedName("txt_captain_arrived")
    public String txt_captain_arrived = "txt_captain_arrived";
    ...
    @SerializedName("txt_resechedule")
    public String txt_resechedule = "txt_resechedule";
    @SerializedName("trip_rescheduled")
    public String trip_rescheduled = "trip_rescheduled";
    @SerializedName("txt_captains")
    public String txt_captains = "txt_captains";
    @SerializedName("txt_total")
    public String txt_total = "txt_total";
    @SerializedName("txt_paid")
    public String txt_paid = "txt_paid";
    @SerializedName("txt_net")
    public String txt_net = "txt_net";

    @SerializedName("user_blocked_text")
    public String user_blocked_text = "user_blocked_text";
    ...
    @SerializedName("txt_schedule_trip_accepted")
    public String txt_schedule_trip_accepted = "txt_schedule_trip_accepted";

    @SerializedName("txt_trip_scheduleAt")
    public String txt_trip_scheduleAt = "txt_trip_scheduleAt";
    @SerializedName("txt_cannot_reg_trip")
    public String txt_cannot_reg_trip = "txt_cannot_reg_trip";
    @SerializedName("text_ok")
    public String text_ok = "text_ok";

    @SerializedName("txt_schedule_sucess")
    public String txt_schedule_sucess = "txt_schedule_sucess";

    @SerializedName("top_twenty_drivers_confirmed")
    public String top_twenty_drivers_confirmed = "top_twenty_drivers_confirmed";

    @SerializedName("text_total_feeCost")
    public String text_total_feeCost = "text_total_feeCost";
    @SerializedName("text_company_key")
    public String text_company_key = "text_company_key";
    @SerializedName("text_request")
    public String text_request = "text_request";
